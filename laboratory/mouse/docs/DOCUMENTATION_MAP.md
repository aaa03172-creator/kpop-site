...
| `docs/ui_ux_revision_plan_2026-05-13_ko.md` | implementation planning / non-canonical UI plan | Scoped follow-up plan for fixing review counters, Review Queue hierarchy, internal ID exposure, export download hierarchy, source-photo missing states, AI copy, and mobile ergonomics; now includes the 2026-05-14 Slices 1-7 completion status and verification summary. |
