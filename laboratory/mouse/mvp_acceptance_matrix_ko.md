...
| A02 | Photo Review | 업로드된 사진은 transcription review candidate를 생성하고, 승인 기반 AI extraction은 reviewable parsed evidence로 저장한다. | Done | `Photo review candidate should be visible in Review Queue`, `AI extraction should save parsed note evidence`, `Extract & Save Review` |
...
| G04 | Experiment traceability는 설계에는 있으나 MVP 자동 흐름에는 아직 약하다. | experiment-mouse link MVP 추가 |
